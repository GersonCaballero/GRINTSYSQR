...
namespace GRINTSYSQR.Web.Tests
{
    public abstract class GRINTSYSQRWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GRINTSYSQRWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GRINTSYSQRWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GRINTSYSQRDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GRINTSYSQRDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GRINTSYSQRDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GRINTSYSQRDbContext, Task<T>> func)
        {
            T result;
